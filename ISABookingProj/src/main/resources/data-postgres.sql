...
insert into users (first_name, last_name, email, password, phone, adress, country, city, reg_type, active, delete_requested) values ('Krstoljub', 'Jakovljevic', 'krstoljub@gmail.com', '$2a$12$f/CV3jLdVkYeETKhdJvenO3ueaKsESVwCnJbMXcTqmFayd0escPya', '45994', 'Prilipac', 'Srbija', 'Pozega', 'HOUSE_OWNER', true, false);
...
insert into users (first_name, last_name, email, password, phone, adress, country, city, reg_type, active, delete_requested) values ('Milenko', 'Bukvic', 'bukvic@gmail.com', '$2a$12$f/CV3jLdVkYeETKhdJvenO3ueaKsESVwCnJbMXcTqmFayd0escPya', '45664', 'Pilatovici', 'Srbija', 'Pozega', 'BOAT_OWNER', false, false);
